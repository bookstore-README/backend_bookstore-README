...
public class ReviewSaveRequest extends ReviewRequest {
    ...
    private ReviewRatingRequest reviewRating;

    public ReviewSaveRequest(String title, String content, Long memberId, Long bookId, ReviewRatingRequest reviewRating) {
        super(title, content);
